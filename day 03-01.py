def intersect(data1, data2):
    ...
    for path in data1:
        ...
        if d == 'L':
            for i in range(0, int(path[1:])):
                wire1.append([lastcoord[0] - 1, lastcoord[1]])
                lastcoord = wire1[-1]
        if d == 'R':
            for i in range(0, int(path[1:])):
                wire1.append([lastcoord[0] + 1, lastcoord[1]])
        ...
        if d == 'U':
            for i in range(0, int(path[1:])):
                wire1.append([lastcoord[0], lastcoord[1] + 1])
                lastcoord = wire1[-1]
        if d == 'D':
            for i in range(0, int(path[1:])):
                wire1.append([lastcoord[0], lastcoord[1] - 1])
    ...
    for path2 in data2:
        d = path2[0]
        if d == 'L':
            for i in range(0, int(path2[1:])):
                wire2.append([lastcoord[0] - 1, lastcoord[1]])
                lastcoord = wire2[-1]
        if d == 'R':
            for i in range(0, int(path2[1:])):
                wire2.append([lastcoord[0] + 1, lastcoord[1]])
        ...
        if d == 'U':
            for i in range(0, int(path2[1:])):
                wire2.append([lastcoord[0], lastcoord[1] + 1])
                lastcoord = wire2[-1]
        if d == 'D':
            for i in range(0, int(path2[1:])):
                wire2.append([lastcoord[0], lastcoord[1] - 1])
